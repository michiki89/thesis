...
\textcolor{green}{
	...
	\begin{enumerate}
  		\item location of the heart  
  		\item anatomy of the heart
  		\item blood flow (pulmonary circle,systematic circle,FŸllungs-/Leerungsphase)
	\end{enumerate}
}
...
The heart consists of four separate  chambers; a left and right atrium as well as a left and right ventricle. The atrium and the ventricle on the same side are connected via the atrioventricular valve, while the left and right side don't exchange blood directly. 
=======
      \begin{enumerate}
         \item erstens.
         \item zweitens.
...
>>>>>>> 6d90842cf2d6bd322b7565e8ce64a86976a548b3
% -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
